    ...
    return (
        <>
            ...
            <div className="mt-2">
                ...
                <Link to="/tuiter/edit-profile"><button type="button" class="btn btn-outline-light float-end">Edit Profile</button></Link>
            </div>
            <div>
                <div className="row">
                    <span className="text-white"> <strong className="text-white">{profile.firstName} {profile.lastName}</strong></span>
                    <span className="text-muted"> @{profile.handle} </span>
                    <span className="text-white mt-2"> {profile.bio}</span>
                    ...
                    <div className="row mt-2">
                    <div className="col-3">
                    <span className="text-white"> <strong className="text-white"> {profile.followingCount}</strong></span><span className="text-muted"> Following</span> 
                    </div>
                    <div className="col-3">
                    <span className="text-white"> <strong className="text-white"> {profile.followersCount} </strong></span><span className="text-muted"> Followers</span>
                    </div>
                    </div>
